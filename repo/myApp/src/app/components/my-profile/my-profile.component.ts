...
export class MyProfileComponent implements OnInit {
  ...
  private planClicked = true;
  private historyClicked = false;
  private detailClicked = false;
  private editDetail = false;
  private orderHistory =false;
  ...
  onDisplayOrder(order: Order) {
    console.log(order);
    this.order=order;
    this.displayOrderDetail=!this.displayOrderDetail;
  }
